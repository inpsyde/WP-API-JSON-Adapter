...
/**
 * Class MenuFieldsController
 *
 * Decorator for the EntityFieldsController to apply menu specific
 * filters to the FieldHandlersRepositories.
 *
 * @package WPAPIAdapter\Core
 */
class MenuFieldsController implements FieldsControllerInterface {
	...
	public function dispatch( \WP_JSON_Response $response ) {
		 ...
		 */
		do_action( 'wpapiadapter_register_menu_change_field_handler', $this->change_repository );

		/**
		 * @param WPAPIAdapter\Core\FieldHandlerRepository
		 */
		do_action( 'wpapiadapter_register_menu_add_field_handler',    $this->add_repository );
