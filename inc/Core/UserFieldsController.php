...
class UserFieldsController implements FieldsControllerInterface {
	...
	public function dispatch( \WP_JSON_Response $response ) {
		 ...
		 */
		do_action( 'wpapiadapter_register_user_change_field_handler', $this->change_repository );

		/**
		 * @param WPAPIAdapter\Core\FieldHandlerRepository
		 */
		do_action( 'wpapiadapter_register_user_add_field_handler',    $this->add_repository );
