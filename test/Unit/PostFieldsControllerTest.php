...
class PostFieldsControllerTest extends TestCase\MockCollectionTestCase {
	...
	public function test_dispatch() {
		 ...
		 */
		\WP_Mock::expectAction( 'wpapiadapter_register_post_change_field_handler', $edit_repo_mock );
		\WP_Mock::expectAction( 'wpapiadapter_register_post_add_field_handler', $add_repo_mock );

		$testee = new Core\PostFieldsController(
